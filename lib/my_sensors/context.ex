defmodule MySensors.Context do
    ...
    case Float.parse(to_string(value)) do
      ...
      {battery_level, _} ->
        case get_node(node_id) do
          ...
          nil -> new_node(%{id: node_id, battery_level: battery_level})
        end
    end
  end
  ...
  def save_sketch_name(%Packet{
    ...
    case get_node(node_id) do
      ...
      nil -> new_node(%{id: node_id, sketch_name: sketch_name})
    end
  end
  ...
  def save_sketch_version(%Packet{
    ...
    case get_node(node_id) do
      ...
      nil -> new_node(%{id: node_id, sketch_version: sketch_version})
    end
  end
