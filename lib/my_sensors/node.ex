defmodule MySensors.Node do
  ...
  def to_struct(
        {__MODULE__, id, battery_level, protocol, sketch_name, sketch_version, config, sensors}
      ) do
    struct(__MODULE__,
      id: id,
  ...
  def from_struct(%__MODULE__{
    ...
    {__MODULE__, id, battery_level, protocol, sketch_name, sketch_version, config,
     Enum.map(sensors || [], &Sensor.from_struct(&1))}
  end
